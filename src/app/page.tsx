  ...
  return (
    <>
      ...
      <section className="gradient-hero border-b border-border">
        <div className="mx-auto grid max-w-[96rem] items-center gap-8 px-3 py-10 sm:gap-12 sm:px-6 sm:py-16 lg:grid-cols-2 lg:px-8 lg:py-24">
          <div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {popular.map((t) => (
              <Link
                ...
                className="group rounded-xl border border-border bg-card p-4 transition-shadow hover:shadow-elegant sm:p-5"
              >
                ...
                <p className="mt-3 text-sm font-semibold text-primary opacity-0 transition-opacity group-hover:opacity-100">
                  Preview template →
                </p>
              </Link>
            ))}
