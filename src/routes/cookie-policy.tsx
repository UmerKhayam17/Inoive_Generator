  ...
  head: () => ({
    meta: [
      { title: `Cookie Policy — ${SITE.name}` },
      {
        name: "description",
        content:
          "Which cookies InvoiceForge uses, why we use them, and how to control or disable them in your browser.",
      },
      { property: "og:title", content: `Cookie Policy — ${SITE.name}` },
      { property: "og:description", content: "Cookies used by InvoiceForge and how to control them." },
